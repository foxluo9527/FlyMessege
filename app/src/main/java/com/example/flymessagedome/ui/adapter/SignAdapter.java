...
public class SignAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        try {
            ((SignViewHolder) holder).sendBtn.setOnClickListener(v -> listener.onItemClick(v, position));
            ((SignViewHolder) holder).delBtn.setOnClickListener(v -> listener.onItemClick(v, position));
            ((SignViewHolder) holder).choice.setOnClickListener(v -> listener.onItemClick(v, position));
