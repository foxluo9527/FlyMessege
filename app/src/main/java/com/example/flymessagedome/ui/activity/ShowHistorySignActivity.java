...
public class ShowHistorySignActivity extends BaseActivity implements UserSignContract.View,BGARefreshLayout.BGARefreshLayoutDelegate{
    ...
    public void initDatas() {
        ...
        adapter.setOnRecyclerViewItemClickListener(new SignAdapter.OnRecyclerViewItemClickListener() {
            @Override
    ...
    public void initUserSign(ArrayList<UserSignModel.SignBean> signsBeans) {
        ...
        Comparator<UserSignModel.SignBean> orderSignComparator = (o1, o2) -> {
        ...
        try {
            Collections.sort(signBeans, orderSignComparator);
        }catch (Exception e){
            e.printStackTrace();
        }
        choices=new boolean[signBeans.size()];
