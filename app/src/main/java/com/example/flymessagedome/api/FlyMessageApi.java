...
public class FlyMessageApi {
    ...
    public Observable<Users> getUsersMsg(int id,String loginToken){return fmService.getUsersMsg(id,loginToken);}
    public Observable<Base> checkUserPhone(String phone,String loginToken){return fmService.checkUserPhone(phone,loginToken);}
    ...
    public Observable<Users> getUsersMsg(String u_name,String loginToken){return fmService.getUsersMsg(u_name,loginToken);}

    public Observable<GroupModel> getGroupMsg(int g_id, String loginToken){return fmService.getGroupMsg(g_id,loginToken);}

    public Observable<MessageModel> getMessage(String loginToken,int pageSize,int pageIndex){return fmService.getMessage(loginToken,pageSize,pageIndex);}
